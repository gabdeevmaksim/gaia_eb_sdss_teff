#!/usr/bin/env python3
"""
Train Random Forest temperature regression model using only Gaia G + BP-RP.
...
This minimal 2-feature model tests how much predictive power comes from
just Gaia photometry alone.
"""
...
def main():
    ...
    model_id = f'rf_gaia_g_bprp_{timestamp}'

    print("=" * 80)
    print("Training Random Forest: Gaia G + BP-RP Only")
    print("=" * 80)
