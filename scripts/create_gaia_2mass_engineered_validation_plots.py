#!/usr/bin/env python3
"""
Create standardized validation plots for Gaia + 2MASS engineered features model.
...
7. feature_importance - Top 30 features bar chart
"""
...
def main():
    ...
    logger.info("="*80)
    logger.info("CREATE GAIA + 2MASS ENGINEERED FEATURES VALIDATION PLOTS")
    logger.info("="*80)

    MODEL_ID = 'rf_gaia_2mass_engineered_20251016_205640'
    MODEL_NAME = 'Gaia + 2MASS Engineered Features Model'
    SUBDIR = 'gaia_2mass_engineered_validation'
    ...
    # Predictions
    pred_file = processed_dir / f'gaia_2mass_engineered_predictions_{MODEL_ID}.parquet'
    ...
    # Color distributions (4 base colors + 2 repeats for layout)
    ...
    # Feature importance (top 30 engineered features)
