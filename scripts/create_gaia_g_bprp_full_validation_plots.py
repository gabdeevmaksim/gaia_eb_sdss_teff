#!/usr/bin/env python3
"""
Create standardized validation plots for Gaia G + BP-RP Full Model.
...
def main():
    ...
    logger.info("="*80)
    logger.info("CREATE GAIA G + BP-RP FULL MODEL VALIDATION PLOTS")
    logger.info("="*80)

    # Use the full dataset model
    MODEL_ID = 'rf_gaia_g_bprp_full_20251022_135438'
    MODEL_NAME = 'Gaia G + BP-RP Full Model'
    SUBDIR = 'gaia_g_bprp_full_validation'
    ...
    # Load training data
    import polars as pl
    train_data_path = data_dir / 'gaia_g_bprp_full_train.parquet'
    ...
    plot_temp_distributions(df_train_subset, df_test_subset, MODEL_ID, SUBDIR,
                           train_col='teff_gaia', pred_col='teff_predicted',
