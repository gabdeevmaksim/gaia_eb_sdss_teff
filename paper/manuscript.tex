...
The cross-matching process significantly reduced the sample size (\ref(table1)). 
...
To mitigate this, we fitted a second-degree polynomial correction to the residuals between the GSP-Phot values and the trusted literature standards in this high-temperature domain. 
